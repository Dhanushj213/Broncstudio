    ...
    return (
        <div className="relative min-h-screen bg-gray-50 dark:bg-black pb-20 overflow-hidden">
            ...
            <div className="relative h-[60vh] w-full overflow-hidden flex flex-col items-center justify-center text-center">
                ...
                {/* Enhanced Transparency Mask for depth and text contrast (more musk) */}
                <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-transparent to-black/60 z-10" />
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(0,0,0,0.6)_0%,transparent_80%)] z-10" />

                <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-gray-50 dark:from-black via-gray-50/80 dark:black/80 to-transparent z-10" />
