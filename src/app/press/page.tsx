    ...
    return (
        <div className="min-h-screen bg-[#FAF9F7] pb-20 pt-[var(--header-height)]">
            ...
            <div className="container-premium max-w-[1000px] mx-auto px-6 py-20 text-center">
                ...
                <h1 className="text-5xl font-heading font-bold text-navy-900 mb-16">
                    Making Headlines.
                </h1>

                <div className="grid gap-12">
                    {FEATURES.map((feature, i) => (
                        <div key={i} className="bg-white p-12 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col md:flex-row items-center gap-12 text-left group">
                            <div className="w-full md:w-1/3 flex items-center justify-center p-6 bg-gray-50 rounded-2xl h-40">
                                <img
                                    src={feature.logo}
                                    alt={feature.name}
                                    className="max-h-12 max-w-full opacity-50 group-hover:opacity-100 transition-opacity grayscale group-hover:grayscale-0"
                                />
                            </div>
                            <div className="w-full md:w-2/3">
                                <blockquote className="text-2xl font-heading font-medium text-navy-900 mb-4 leading-normal">
                                    "{feature.quote}"
                                </blockquote>
                ...
                <div className="mt-24">
                    <h3 className="text-xl font-bold text-navy-900 mb-6">Press Inquiries</h3>
                    <p className="text-gray-500 mb-6">For media kits and interview requests, please contact our PR team.</p>
                    <a href="mailto:press@broncstudio.com" className="bg-navy-900 text-white font-bold py-3 px-8 rounded-full hover:bg-coral-500 transition-colors">
