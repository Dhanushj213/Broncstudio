    ...
    return (
        <InfoPage title="Terms & Conditions" category="Policies">
            <div className="space-y-6 text-gray-700 text-sm leading-relaxed">
                ...
                <h3 className="text-lg font-bold text-navy-900 mt-6">1. General</h3>
                ...
                <h3 className="text-lg font-bold text-navy-900 mt-6">2. Products & Pricing</h3>
                ...
                <h3 className="text-lg font-bold text-navy-900 mt-6">3. Accounts</h3>
                ...
                <h3 className="text-lg font-bold text-navy-900 mt-6">4. Intellectual Property</h3>
                ...
                <h3 className="text-lg font-bold text-navy-900 mt-6">5. Governing Law</h3>
