    ...
    return (
        <InfoPage title="Privacy Policy" category="Policies">
            <div className="space-y-6 text-gray-700 text-sm leading-relaxed">
                ...
                <h3 className="text-lg font-bold text-navy-900 mt-6">1. Information We Collect</h3>
                ...
                <h3 className="text-lg font-bold text-navy-900 mt-6">2. How We Use Your Information</h3>
                <ul className="list-disc pl-5">
                ...
                <h3 className="text-lg font-bold text-navy-900 mt-6">3. Data Security</h3>
                ...
                <h3 className="text-lg font-bold text-navy-900 mt-6">4. Contact Us</h3>
