    ...
    return (
        <InfoPage title="Shipping Information">
            <div className="space-y-8 text-gray-700 dark:text-gray-300">
                ...
                <h3 className="text-xl font-bold text-navy-900 dark:text-white mt-8">Delivery Timelines</h3>
                ...
                <h3 className="text-xl font-bold text-navy-900 dark:text-white mt-8">Shipping Charges</h3>
                <p>
                    We offer <strong>Free Shipping</strong> on all orders above ₹999.
                    For orders below ₹999, a flat shipping fee of ₹99 applies.
                </p>

                <h3 className="text-xl font-bold text-navy-900 dark:text-white mt-8">Order Processing</h3>
                <p>
