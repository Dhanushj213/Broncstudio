                ...
                <div className="flex gap-6 overflow-x-auto pb-8 snap-x snap-mandatory no-scrollbar -mx-6 px-6">
                    {sections.map((item) => (
                        <Link
                            ...
                            className="group relative min-w-[220px] md:min-w-[calc(33.33%-16px)] lg:min-w-[calc(25%-18px)] aspect-[3/2] overflow-hidden rounded-2xl cursor-pointer snap-start shrink-0 shadow-sm hover:shadow-xl transition-all"
                        >
                            <img
                                src={item.image_url}
                                alt={item.title}
