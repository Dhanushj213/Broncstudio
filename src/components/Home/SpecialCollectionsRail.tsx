    ...
    return (
        <section className="relative pt-8 pb-4 overflow-hidden bg-gradient-to-b from-transparent to-[#F8F5F2] dark:to-black/40">
            ...
            <div className="md:hidden px-6 mt-4 flex justify-center">
                <Link href="/special" className="inline-flex items-center gap-2 bg-white text-navy-900 border border-black/10 px-8 py-4 rounded-full font-bold text-sm uppercase tracking-wider w-full justify-center shadow-lg hover:shadow-xl transition-shadow">
