...
export default function MobilePillsRail() {
    ...
    return (
        <div className="md:hidden w-full bg-white dark:bg-navy-900 py-3 border-b border-gray-100 dark:border-white/5 sticky top-[var(--header-height)] z-20 shadow-sm">
            <div className="flex overflow-x-auto no-scrollbar gap-2 px-4 snap-x items-center">
                <Link
                    href="/shop/trending"
                    className="flex-shrink-0 snap-start bg-navy-900 text-white dark:bg-white dark:text-navy-900 border border-navy-900 dark:border-white px-5 py-2 rounded-full text-xs font-bold uppercase tracking-wide shadow-md"
                >
                    Trending
                </Link>
